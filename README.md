...
- 🧭 **שני מצבי תצוגה** (נבחר בהגדרות → תצוגה): **מיקרופון מרחף** או **תפריט צד** — תפריט רדיאלי ניאוני צמוד לקצה הימני של המסך, עם שלוש פעולות (תמלול לייב · תרגום קובץ · תמלול קובץ) ובורר קבצים נייטיבי
